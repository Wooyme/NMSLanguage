...
public interface SimpleLanguageVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SimpleLanguageParser#label_block}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLabel_block(SimpleLanguageParser.Label_blockContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SimpleLanguageParser#middle_term}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMiddle_term(SimpleLanguageParser.Middle_termContext ctx);
	/**
